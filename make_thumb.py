...
d.text((tx,372),"~ 갑옷 이야기 두 번째 모험 · 진짜 숫자 편 ~",font=F(malgun,27),fill="#2E8B8B")
d.text((tx,430),"부엉이 박사가 은행 12곳을 재어보니",font=F(malgun,26),fill="#8a7252")
d.text((tx,466),"갑옷 288조원이 풀리고 안전점수 +3.2점!",font=F(malgun,26),fill="#8a7252")
d.text((tx,520),"단, 위험한 기업대출에 제대로 써야 효과가 커요",font=F(malgunbd,23),fill="#cf5a3e")
